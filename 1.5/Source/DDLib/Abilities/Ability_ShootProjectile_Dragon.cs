...

{
    ...
    public class AbilityExtension_Projectile_Dragon : DefModExtension
    {
    ...
    public class AbilityExtension_ShootProjectile_Snow_Dragon : DefModExtension
    {
        public float radius = 3f;
        public float depth = 1f;
    }

    public class Ability_ShootProjectile_Snow_Dragon : Ability_ShootProjectile
    {
