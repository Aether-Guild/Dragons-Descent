...
public class Verb_ArcSprayIncinerator_Dragon : Verb_ShootBeam
{
    ...
    {
        sprayer = GenSpawn.Spawn(DD_ThingDefOf.DD_IncineratorSpray_Dragon, caster.Position, caster.Map) as IncineratorSpray;
        base.WarmupComplete();
    ...
    protected override bool TryCastShot()
    {
        ...
        MoteDualAttached moteDualAttached = MoteMaker.MakeInteractionOverlay(A: new TargetInfo(caster.Position, caster.Map), moteDef: DD_ThingDefOf.DD_Mote_IncineratorBurst_Necro, B: new TargetInfo(intVec, caster.Map));
