...
namespace DD
{
    public class DraconicSettingsGUI
    {
        ...
        private const string Format_HuntingPawns_Title = "Setting_HuntingPawns";
        private const string Format_HuntingPawnsg_Label = "Setting_HuntingPawns_Title";
        private const string Format_HuntingPawns_Desc = "Setting_HuntingPawnsg_Description";
