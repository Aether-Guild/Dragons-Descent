...
namespace DD
{
    ...
    //public class SoaringCaravan : WorldObject, IThingHolder, IIncidentTarget, ILoadReferenceable, ITrader
    //{
    //    private int uniqueId = -1;

    //    private string nameInt;

    //    public ThingOwner<Pawn> carriers;
    //    public ThingOwner<Pawn> riders;
