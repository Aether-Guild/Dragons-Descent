...
namespace DD
{
    public class Mote_ParticleController : Mote
    {
        private float duration;
        private List<SubMote_Particle> motes;

        public IEnumerable<SubMote_Particle> SubMotes => motes.Where(mote => !mote.Finished);
