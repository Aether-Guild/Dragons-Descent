...
public class CompAbilityEffect_Dragon_Fire : CompAbilityEffect
{
	private readonly List<IntVec3> tmpCells = new List<IntVec3>();

	private new CompProperties_Ability_Dragon_Fire Props => (CompProperties_Ability_Dragon_Fire)props;
