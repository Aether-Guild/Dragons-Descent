...
public class CompAbilityEffect_FireSpew_Dragon : CompAbilityEffect
{
	private readonly List<IntVec3> tmpCells = new List<IntVec3>();

	private new CompProperties_AbilityFireSpew_Dragon Props => (CompProperties_AbilityFireSpew_Dragon)props;
