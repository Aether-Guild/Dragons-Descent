...
namespace DD
{
    ...
    //                 }
    //                 VEF.Abilities.AbilityDef DD_DraconicFlight = DefDatabase<VEF.Abilities.AbilityDef>.GetNamed("DD_DraconicFlight");
    //                 if (DD_DraconicFlight == null)
    //                 {
    //                     Log.ErrorOnce("Could not find the GRDragon Flight ability.", 18463572);
    //                 }
    //                 else
    //                 {
    //                     abilitiesComp.GiveAbility(DD_DraconicFlight);
    //                 }
    //             }
    //         }
    //     }
