...
//
//             DoLabeledAreaField(inRect.TopHalf(), "AbilitySetting_Label_Gain".Translate(), gainConditions, ref Scroll_Position_Gain);
//         }
//
...
//             if (comp != null)
//             {
//                 // return comp.Definitions.First(entry => entry.abilityDef == def);
//             }
//             return pawn.def.modExtensions.OfType<AbilityDefinitionExtension>()
//                 .SelectMany(ext => ext.abilities)
//                 .FirstOrDefault(ability => ability.abilityDef == def);
//         }
//
//         private void DoAbilityPawns(Rect inRect, IEnumerable<Pawn> pawns)
//         {
//             Widgets.DrawBoxSolid(inRect, Color.blue);
//             // Add more implementation if needed for displaying pawns
//         }
//
