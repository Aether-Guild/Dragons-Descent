...
//namespace DD
//{
//    public class DraconicFrost : AbstractEffect
//    {
...
//        protected override DamageDef EffectDamageDef => DD_DamageDefOf.DraconicFrost;

//        //protected override ThinkTreeDef ThinkTreeOverride => DD_ThinkTreeDefOf.DraconicFreezeResponse;
...
//            if (Map.weatherManager.RainRate > 0 && VulnerableToRain() && Rand.Chance(0.6f))
//            {
...
//        {
//            EffectUtility.ApplyEffect(thing, def, Rand.Range(MinEffectSize, MaxEffectSize));
//        }
...
//        {
//            return (def == DD_EffectDefOf.DraconicFire);
//        }
//    }
//}
