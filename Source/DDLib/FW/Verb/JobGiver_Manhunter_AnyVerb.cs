    ...
    public class JobGiver_Manhunter_AnyVerb : JobGiver_Manhunter
    {
        ...
        protected override Job TryGiveJob(Pawn pawn)
        {
            ...
            if (verb != null && !verb.IsMeleeAttack && verb.Available())
            {
                ...
                Pawn target = AttackTargetFinder.BestAttackTarget(pawn, TargetScanFlags.NeedThreat | TargetScanFlags.NeedLOSToAll | TargetScanFlags.NeedAutoTargetable, (Thing x) => x is Pawn && (int)x.def.race.intelligence >= 1, canBash: true) as Pawn;
